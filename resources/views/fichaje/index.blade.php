            ...
            <div class="relative overflow-hidden rounded-none bg-white shadow-2xl ring-1 ring-black/10 w-full h-full min-h-screen flex flex-col">
                ...
                <nav class="md:hidden border-t bg-white shadow-lg">
                    <div class="grid grid-cols-4 text-center text-xs font-semibold">
                        <a href="{{ url('/perfil') }}" class="py-3 flex flex-col items-center gap-1 hover:bg-gray-50 transition">
                            <span class="text-lg">👤</span>
                            <span>Perfil</span>
                        </a>
                        <a href="{{ route('normas.index') }}" class="py-3 flex flex-col items-center gap-1 hover:bg-gray-50 transition">
                            <span class="text-lg">📋</span>
                            <span>Normas</span>
                        </a>
                        <a href="{{ url('/fichaje') }}" class="py-3 flex flex-col items-center gap-1 text-purple-600 bg-purple-50 transition">
                            <span class="text-lg">⏱️</span>
                            <span>Fichaje</span>
                        </a>
                        <a href="{{ url('/horas') }}" class="py-3 flex flex-col items-center gap-1 hover:bg-gray-50 transition">
                            <span class="text-lg">📊</span>
                            <span>Horas</span>
                        </a>
                    </div>
