...
<head>
    ...
    <style>
        /* Estilos originales de tu primer archivo */
        .diagonal-pattern {
        ...
        /* Tarjetas de normas con el borde negro de 10px */
        .norma-card {
            background: white;
            margin-bottom: 15px;
            padding: 20px;
        ...
        /* Configuración para descarga limpia en PDF */
        @media print {
...
<body class="min-h-screen w-screen bg-gradient-to-br from-purple-100 to-blue-100 flex flex-col">
    ...
    <div class="flex-1 flex flex-col items-stretch justify-stretch p-0 w-full h-full">
        <div class="w-full">
            <div class="relative overflow-hidden rounded-none bg-white shadow-2xl ring-1 ring-black/10 w-full h-full min-h-screen flex flex-col">
                ...
                <header class="h-14 bg-gradient-to-r from-gray-900 to-black text-white flex items-center justify-between px-4 btn-print-ignore">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/logofitxategi.png') }}" alt="Logo" class="h-9 w-9 rounded-full shadow-lg object-contain bg-white">
                    ...
                    <div class="flex items-center gap-2">
                        <button class="h-8 w-8 rounded-full"><img src="{{ asset('images/euskalherria.png') }}"></button>
                        <button class="h-8 w-8 rounded-full"><img src="{{ asset('images/españa.png') }}"></button>
                    </div>
                </header>
                ...
                <main class="bg-[#f2dcff] p-6 md:p-10 flex-1">
                    <div class="max-w-2xl mx-auto space-y-6 animate-fade-in">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="norma-card">
                                <span class="block text-xl uppercase font-black">5. Supervisión y Control del Profesorado</span>
                                <p class="text-gray-700 font-medium mt-1">El profesorado tiene acceso total al sistema para supervisar los fichajes en tiempo real. Puede validar, modificar o corregir cualquier registro para garantizar que las horas de asistencia sean correctas.</p>
                            </div>
                        </div>
                ...
                <nav class="md:hidden border-t bg-white shadow-lg btn-print-ignore">
                    <div class="grid grid-cols-4 text-center text-xs font-semibold">
                        <a href="{{ url('/perfil') }}" class="py-3 flex flex-col items-center gap-1 {{ request()->is('perfil*') ? 'text-purple-600 bg-purple-50 nav-active' : '' }}">
                            <span class="text-lg">👤</span><span>Perfil</span>
                        </a>
                        <a href="{{ route('normas.index') }}" class="py-3 flex flex-col items-center gap-1 {{ request()->is('normas*') ? 'text-purple-600 bg-purple-50 nav-active' : '' }}">
                            <span class="text-lg">📋</span><span>Normas</span>
                        </a>
                        <a href="{{ url('/incidencias') }}" class="py-3 flex flex-col items-center gap-1">
                            <span class="text-lg">⏱️</span><span>Incidencias</span>
                        </a>
                        <a href="{{ url('/horas') }}" class="py-3 flex flex-col items-center gap-1">
                            <span class="text-lg">📊</span><span>Horas</span>
                        </a>
                    </div>
                </nav>
            </div>
