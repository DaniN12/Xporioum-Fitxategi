...
<body class="min-h-screen bg-slate-100 flex items-center justify-center">
    ...
    <div class="w-full max-w-md mx-auto p-6 animate-fade-in">
        <div class="bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="w-full space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php endif; ?>
            ...
            <div class="mt-6 text-sm text-gray-500">
                ¿Ya tienes cuenta? <a href="<?php echo e(route('login')); ?>" class="text-purple-600 hover:underline">Inicia sesión</a>
            </div>
        </div>
...
<?php /**PATH D:\Joane\UniServerZ\www\Fitxategi-Joane\resources\views/auth/register.blade.php ENDPATH**/ ?>