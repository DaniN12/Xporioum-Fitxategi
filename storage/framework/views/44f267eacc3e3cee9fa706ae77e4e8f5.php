...
<body class="min-h-screen bg-white flex flex-col overflow-x-hidden">
    ...
    <header class="h-14 flex-none bg-gradient-to-r from-gray-900 to-black text-white flex items-center justify-between px-4 z-20">
        <div class="flex items-center gap-3">
            <img src="<?php echo e(asset('images/fitxategi.png')); ?>" alt="Logo" class="h-9 w-9 rounded-full shadow-lg object-contain bg-white">
    ...
    <nav class="hidden md:flex items-center justify-center gap-10 bg-gradient-to-r from-[#d7a6ff] to-[#e5b8ff] py-3 font-bold text-black shadow-sm">
        <a href="<?php echo e(url('/perfil')); ?>" class="relative <?php echo e(request()->is('perfil*') ? 'nav-active' : ''); ?> hover:text-purple-800 transition">Perfil</a>
        <a href="<?php echo e(route('normas.index')); ?>" class="relative <?php echo e(request()->is('normas*') ? 'nav-active' : ''); ?> hover:text-purple-800 transition">Normas</a>
        <a href="<?php echo e(url('/incidencias')); ?>" class="relative <?php echo e(request()->is('incidencias*') ? 'nav-active' : ''); ?> hover:text-purple-800 transition">Incidencias</a>
        <a href="<?php echo e(url('/fichaje')); ?>" class="relative <?php echo e(request()->is('fichaje*') ? 'nav-active' : ''); ?> hover:text-purple-800 transition">Fichar</a>
        <a href="<?php echo e(url('/horas')); ?>" class="relative <?php echo e(request()->is('horas*') ? 'nav-active' : ''); ?> hover:text-purple-800 transition">Tus horas</a>
    </nav>
...
<?php /**PATH D:\Joane\UniServerZ\www\Fitxategi-Joane\resources\views/fichaje/index.blade.php ENDPATH**/ ?>