    ...
    <div class="flex-1 flex flex-col w-full">
        ...
        <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 btn-print-ignore">
            <div class="grid grid-cols-5 text-center text-[10px] font-bold uppercase">
                <a href="<?php echo e(url('/perfil')); ?>" class="py-3 flex flex-col items-center gap-1 <?php echo e(request()->is('perfil*') ? 'text-purple-600 bg-purple-50' : 'text-gray-400'); ?>">
                    <span class="text-xl">👤</span><span>Perfil</span>
                </a>
                <a href="<?php echo e(route('normas.index')); ?>" class="py-3 flex flex-col items-center gap-1 <?php echo e(request()->is('normas*') ? 'text-purple-600 bg-purple-50' : 'text-gray-400'); ?>">
                    <span class="text-xl">📋</span><span>Normas</span>
                </a>
                <a href="<?php echo e(url('/incidencias')); ?>" class="py-3 flex flex-col items-center gap-1 <?php echo e(request()->is('incidencias*') ? 'text-purple-600 bg-purple-50' : 'text-gray-400'); ?>">
                    <span class="text-xl">⚠️</span><span>Incidencias</span>
                </a>
                <a href="<?php echo e(url('/fichaje')); ?>" class="py-3 flex flex-col items-center gap-1 <?php echo e(request()->is('fichaje*') ? 'text-purple-600 bg-purple-50' : 'text-gray-400'); ?>">
                    <span class="text-xl">⏱️</span><span>Fichar</span>
                </a>
                <a href="<?php echo e(url('/horas')); ?>" class="py-3 flex flex-col items-center gap-1 <?php echo e(request()->is('horas*') ? 'text-purple-600 bg-purple-50' : 'text-gray-400'); ?>">
...
<?php /**PATH D:\Joane\UniServerZ\www\DaniN12-Xporioum-Fitxategi\resources\views/normas/index.blade.php ENDPATH**/ ?>