    ...
    <div class="flex-1 flex flex-col w-full">
        <header class="h-14 flex-none bg-gradient-to-r from-gray-900 to-black text-white flex items-center justify-between px-4 z-10">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/logofitxategi.png')); ?>" alt="Logo Fitxategi" class="h-9 w-9 rounded-full shadow-lg object-contain bg-white">
...
<?php /**PATH D:\Joane\UniServerZ\www\DaniN12-Xporioum-Fitxategi\resources\views/incidencias/create.blade.php ENDPATH**/ ?>