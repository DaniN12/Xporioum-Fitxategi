                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <?php if(auth()->guard()->check()): ?>
                                <h1 class="text-xl font-bold text-gray-800">Hola, <?php echo e(Auth::user()->name); ?> 👋</h1>
                            <?php else: ?>
                                <h1 class="text-xl font-bold text-gray-800">Hola, invitado 👋</h1>
                            <?php endif; ?>
                            <p class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::now()->locale('es')->isoFormat('dddd, D [de] MMMM')); ?></p>
                        </div>
...
<?php /**PATH D:\Joane\UniServerZ\www\DaniN12-Xporioum-Fitxategi\resources\views/perfil/index.blade.php ENDPATH**/ ?>